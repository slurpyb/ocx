...
- **Native OS notifications first** - Uses Android Termux notifications when available, macOS Notification Center via `alerter`, plus Windows Toast and Linux notify-send via `node-notifier`.
