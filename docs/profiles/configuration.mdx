...
OCX configurations (`ocx.jsonc`) merge when using profiles:
...
OpenCode configurations (`opencode.jsonc`) cascade:
...
Specify which profile to use in your project's `.opencode/ocx.jsonc`:
