...
The command always exits with code 1 on validation failure, making it suitable for continuous integration pipelines:
...
Suppresses all output (including errors). Check the exit code to determine success (0) or failure (1).
